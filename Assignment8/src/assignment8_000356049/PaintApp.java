...
public class PaintApp extends Application {
    /** The canvas where shapes are drawn */
    private Canvas canvas;

    /** The graphics context for drawing on the canvas */
    private GraphicsContext gc;

    /** A list to store different geometric shapes */
    private ArrayList<GeometricObject> shapes = new ArrayList<>();

    /** The currently selected drawing color */
    private Color currentColor = Color.BLACK;

    /** Indicates whether to draw circles or square */
    private boolean drawCircle = true;

    /** The starting X and Y coordinates for drawing */
    private double startX, startY;

    /** The previous X and Y coordinates for drawing */
    private double prevX, prevY;

    /** Text field for specifying the X-coordinate of a shape */
    private TextField locationXField;

    /** Text field for specifying the Y-coordinate of a shape */
    private TextField locationYField;

    /** Text field for specifying the size of a shape */
    private TextField sizeField;

    /** A color picker for selecting drawing colors */
